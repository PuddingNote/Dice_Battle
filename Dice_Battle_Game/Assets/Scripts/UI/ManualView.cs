    ...
    public sealed class ManualView
    {
        ...
        private static readonly Page[] Pages =
        {
            ...
            new Page("점수 & 리롤",
                ...
                "· 리롤은 한 판에 단 1번 사용 가능하지만, 광고 시청 후 한 번 더 사용 가능합니다.\n\n" + 
                "· 주사위를 한번 더 굴려 두개의 주사위 중 하나를 선택합니다.\n\n" +
                "· 다시 굴린 주사위는 기존과 다른 숫자가 나옵니다."),

            new Page("난이도 & 해금",
                "· 난이도는 Lv.1 ~ Lv.10이며, 해금한 것 중에서 직접 골라 플레이합니다.\n\n" +
                "· 높은 난이도일수록 승리 시 얻는 점수도, 패배 시 잃는 점수도 커집니다.\n\n" +
                "· 지금까지 도달한 최고 점수가 기준에 닿으면 새 난이도가 해금됩니다.\n\n" +
                "· 한 번 해금한 난이도는 점수가 내려가도 다시 잠기지 않습니다.\n\n" +
                "· 이길 수 있는 가장 높은 난이도를 고르는 것이 가장 빠릅니다."),
        };
